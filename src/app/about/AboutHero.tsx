...
export default function AboutHero() {
  return (
    <section
      className="relative pt-36 pb-20 flex items-center"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-300 text-xl max-w-2xl">
            Ahmedabad&apos;s trusted industrial engineering partner — delivering excellence
            in electrical, mechanical, and material handling solutions since 2001.
          </p>
        </motion.div>
      </div>
    </section>
